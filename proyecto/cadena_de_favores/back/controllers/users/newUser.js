...
async function newUser(req, res, next) {
  ...
  try {
    ...
    try {
      await sendMail({
        email,
        title: "Valida tu cuenta de usuario en la app cadena de favores",
        content: `Para validar tu cuenta de usuario en la app cadena de favores haz click aquí: ${validationURL}`,
      });
    } catch (error) {
